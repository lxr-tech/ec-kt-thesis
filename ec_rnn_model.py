...
class EC(nn.Module):
    ...
    def __init__(self, inp_size, mid_size, num_words, num_types=8, num_layers=1, weight=None):
        ...
        self.q_net = nn.RNN(input_size=inp_size, hidden_size=mid_size, num_layers=num_layers,
    ...
    def forward(self, x):
        ...
        pred = ques[:, -1, :].squeeze(1)
        # pred.shape = (batch, feature)
        pred = self.sigmoid(self.k_net(pred))
